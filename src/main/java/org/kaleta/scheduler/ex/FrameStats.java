...
public class FrameStats extends JFrame {
    ...
    private void initPanelTop(){
        ...
        comboBoxGraphs.addItem("vydaje, prjimy");
        comboBoxGraphs.addItem("balance");
        comboBoxGraphs.addItem("vydaje denne + najvacsie tri polozky");
        comboBoxGraphs.addItem("struktorovane vydaje");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (comboBoxGraphs.getSelectedIndex()){
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        /**///setSize(new Dimension(1160,735));
                        break;
                    case 3:
                        /**/setSize(new Dimension(1200,750));
                        break;
